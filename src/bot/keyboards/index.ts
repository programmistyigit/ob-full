  ...
  const buttons = [
    [
      Markup.button.callback(
        savedMessage ? '✅ Saved Messages: on' : '❌ Saved Messages: off',
        'toggle_saved'
      ),
    ],
    [
      Markup.button.callback(`📂 Archive: ${archiveMode}`, 'change_archive_mode'),
    ],
    [
      Markup.button.callback(`🌐 Lang: ${language.toUpperCase()}`, 'change_language'),
    ],
    [
      Markup.button.callback(
        outreachEnabled ? '✅ Outreach: on' : '❌ Outreach: off',
        'toggle_outreach'
      ),
    ],
    [
